...
architecture behav of read_data is 
    ...
    signal buf_0_V_blk_n : STD_LOGIC;
...
begin
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(real_start, ap_done_reg, ap_enable_reg_pp0_iter1, input_data_V_0_vld_out, buf_0_V_full_n)
    begin
                ap_block_pp0_stage0_flag00001001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = real_start) and ((ap_const_logic_0 = real_start) or (ap_done_reg = ap_const_logic_1))) or (((ap_const_logic_0 = input_data_V_0_vld_out) or (ap_const_logic_0 = buf_0_V_full_n)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(real_start, ap_done_reg, ap_enable_reg_pp0_iter1, input_data_V_0_vld_out, buf_0_V_full_n)
    begin
                ap_block_pp0_stage0_flag00011001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = real_start) and ((ap_const_logic_0 = real_start) or (ap_done_reg = ap_const_logic_1))) or (((ap_const_logic_0 = input_data_V_0_vld_out) or (ap_const_logic_0 = buf_0_V_full_n)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(real_start, ap_done_reg, ap_enable_reg_pp0_iter1, input_data_V_0_vld_out, buf_0_V_full_n)
    begin
                ap_block_pp0_stage0_flag00011011 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = real_start) and ((ap_const_logic_0 = real_start) or (ap_done_reg = ap_const_logic_1))) or (((ap_const_logic_0 = input_data_V_0_vld_out) or (ap_const_logic_0 = buf_0_V_full_n)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(input_data_V_0_vld_out, buf_0_V_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_const_logic_0 = input_data_V_0_vld_out) or (ap_const_logic_0 = buf_0_V_full_n));
    end process;
    ...
    buf_0_V_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, buf_0_V_full_n, ap_block_pp0_stage0_flag00000000)
    begin
    ...
    buf_0_V_din <= input_data_V_0_data_out;

    buf_0_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
