...
HD_PWD='C:/Users/Raul/Documents/GOERTZEL_HLS/goertzelv10/ALG/solution22/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log goertzel_algorithm_simpler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source goertzel_algorithm_simpler.tcl
