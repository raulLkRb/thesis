...
HD_PWD='C:/Users/Raul/Documents/GOERTZEL_HLS/goertzelv10/ALG/solution22/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log goertzel_algorithm_simpler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source goertzel_algorithm_simpler.tcl -notrace
