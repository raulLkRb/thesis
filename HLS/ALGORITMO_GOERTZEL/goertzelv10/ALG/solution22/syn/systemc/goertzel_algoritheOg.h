...
#ifndef __goertzel_algoritheOg__HH__
#define __goertzel_algoritheOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(goertzel_algoritheOg) {
    ...
    SC_CTOR(goertzel_algoritheOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
