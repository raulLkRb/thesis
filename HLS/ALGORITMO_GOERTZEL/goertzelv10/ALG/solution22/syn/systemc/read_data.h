...
struct read_data : public sc_module {
    ...
    sc_out< sc_lv<32> > buf_0_V_din;
    sc_in< sc_logic > buf_0_V_full_n;
    sc_out< sc_logic > buf_0_V_write;
    ...
    sc_signal< sc_logic > buf_0_V_blk_n;
    ...
    void thread_buf_0_V_blk_n();
    void thread_buf_0_V_din();
    void thread_buf_0_V_write();
