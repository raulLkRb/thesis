...
struct Loop_2_proc : public sc_module {
    ...
    sc_in< sc_lv<32> > y_V_dout;
    sc_in< sc_logic > y_V_empty_n;
    sc_out< sc_logic > y_V_read;
    ...
    sc_signal< sc_lv<1> > exitcond_reg_142;
    sc_signal< sc_logic > output_AX_ALG_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_exitcond_reg_142;
    sc_signal< sc_lv<5> > k_reg_113;
    ...
    sc_signal< sc_lv<5> > k_1_fu_130_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > last_assign_fu_136_p2;
    sc_signal< sc_lv<1> > last_assign_reg_151;
    ...
    void thread_k_1_fu_130_p2();
    void thread_last_assign_fu_136_p2();
