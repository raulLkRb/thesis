...
architecture behav of goertzel_algorithm_simpler is 
    ...
    "goertzel_algorithm_simpler,hls_ip_2017_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.623500,HLS_SYN_LAT=114745,HLS_SYN_TPT=114746,HLS_SYN_MEM=4,HLS_SYN_DSP=16,HLS_SYN_FF=1420,HLS_SYN_LUT=1783}";
