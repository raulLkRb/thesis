...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_AX_ALG_TDATA { O 32 vector } output_AX_ALG_TVALID { O 1 bit } output_AX_ALG_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_AX_ALG_TDEST { O 5 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_y_V \
    op interface \
    ports { y_V_dout { I 32 vector } y_V_empty_n { I 1 bit } y_V_read { O 1 bit } } \
} "
}
