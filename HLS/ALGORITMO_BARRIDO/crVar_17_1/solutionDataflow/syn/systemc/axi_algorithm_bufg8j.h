...
#ifndef _axi_algorithm_bufg8j_H_
#define _axi_algorithm_bufg8j_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "axi_algorithm_bufg8j_memcore.h"

SC_MODULE(axi_algorithm_bufg8j) {
...
protected:
    ...
    axi_algorithm_bufg8j_memcore* axi_algorithm_bufg8j_memcore_U;
...
public:
    ...
    SC_CTOR(axi_algorithm_bufg8j) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        axi_algorithm_bufg8j_memcore_U = new axi_algorithm_bufg8j_memcore("axi_algorithm_bufg8j_memcore_U");
        axi_algorithm_bufg8j_memcore_U->clk      ( clk );
        axi_algorithm_bufg8j_memcore_U->reset    ( reset );
        axi_algorithm_bufg8j_memcore_U->ce0      ( i_ce0 );
        axi_algorithm_bufg8j_memcore_U->we0      ( i_we0 );
        axi_algorithm_bufg8j_memcore_U->address0 ( memcore_iaddr );
        axi_algorithm_bufg8j_memcore_U->d0       ( i_d0 );
        axi_algorithm_bufg8j_memcore_U->q0       ( i_q0 );

        axi_algorithm_bufg8j_memcore_U->ce1      ( t_ce0 );
        axi_algorithm_bufg8j_memcore_U->we1      ( t_we0 );
        axi_algorithm_bufg8j_memcore_U->address1 ( memcore_taddr );
        axi_algorithm_bufg8j_memcore_U->d1       ( t_d0 );
        axi_algorithm_bufg8j_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "axi_algorithm_bufg8j.trace");
            // ports
