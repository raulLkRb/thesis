...
#ifndef __axi_algorithm_macfYi__HH__
#define __axi_algorithm_macfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(axi_algorithm_macfYi) {
    ...
    SC_CTOR(axi_algorithm_macfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
