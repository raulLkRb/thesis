...
set ID 27
set MemName axi_algorithm_bufg8j_memcore
...
set MemName axi_algorithm_bufg8j
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 30 \
    name input_AX_ALG_data_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TDATA { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 31 \
    name input_AX_ALG_keep_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TKEEP { I 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_keep_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 32 \
    name input_AX_ALG_strb_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TSTRB { I 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 33 \
    name input_AX_ALG_user_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TUSER { I 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 34 \
    name input_AX_ALG_last_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TLAST { I 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 35 \
    name input_AX_ALG_id_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TID { I 5 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_id_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 36 \
    name input_AX_ALG_dest_V \
    reset_level 0 \
    sync_rst true \
    corename {input_AX_ALG} \
    metadata {  } \
    op interface \
    ports { input_AX_ALG_TDEST { I 5 vector } input_AX_ALG_TVALID { I 1 bit } input_AX_ALG_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_AX_ALG_dest_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_AX_ALG_TDEST { O 5 vector } output_AX_ALG_TVALID { O 1 bit } output_AX_ALG_TREADY { I 1 bit } } \
} "
} else {
