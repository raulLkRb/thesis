...
output   ap_idle;
output   ap_ready;
output  [31:0] full_fifo_out_din;
input   full_fifo_out_full_n;
output   full_fifo_out_write;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_start) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1)))) begin
        full_fifo_out_blk_n = full_fifo_out_full_n;
    end else begin
        full_fifo_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_start) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
        full_fifo_out_write = 1'b1;
    end else begin
        full_fifo_out_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_flag00001001 = ((ap_done_reg == 1'b1) | ((1'b1 == ap_start) & ((1'b0 == ap_start) | (1'b0 == full_fifo_out_full_n) | (ap_done_reg == 1'b1))) | ((1'b0 == input_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011001 = ((ap_done_reg == 1'b1) | ((1'b1 == ap_start) & ((1'b0 == ap_start) | (1'b0 == full_fifo_out_full_n) | (ap_done_reg == 1'b1))) | ((1'b0 == input_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011011 = ((ap_done_reg == 1'b1) | ((1'b1 == ap_start) & ((1'b0 == ap_start) | (1'b0 == full_fifo_out_full_n) | (ap_done_reg == 1'b1))) | ((1'b0 == input_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp0_iter1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((1'b0 == ap_start) | (1'b0 == full_fifo_out_full_n) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == input_data_V_0_vld_out);
end
...
assign full_fifo_out_din = full_fifo;
