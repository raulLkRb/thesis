...
reg   [0:0] ap_reg_pp0_iter1_tmp_reg_135;
reg   [2:0] i_reg_101;
...
wire   [2:0] i_1_fu_118_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] last_assign_fu_129_p2;
reg   [0:0] last_assign_reg_144;
reg    ap_block_pp0_stage0_flag00011011;
reg    ap_condition_pp0_exit_iter0_state2;
wire   [31:0] tmp_1_fu_124_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == output_last_V_1_vld_in) & (1'b1 == output_last_V_1_ack_in))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd0 == tmp_fu_112_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == tmp_fu_112_p2))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state5) & ~((1'b0 == output_data_V_1_ack_in) | (1'b0 == output_keep_V_1_ack_in) | (1'b0 == output_strb_V_1_ack_in) | (1'b0 == output_user_V_1_ack_in) | (1'b0 == output_last_V_1_ack_in) | (1'b0 == output_id_V_1_ack_in) | (1'b0 == output_dest_V_1_ack_in))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & ~((1'b0 == output_data_V_1_ack_in) | (1'b0 == output_keep_V_1_ack_in) | (1'b0 == output_strb_V_1_ack_in) | (1'b0 == output_user_V_1_ack_in) | (1'b0 == output_last_V_1_ack_in) | (1'b0 == output_id_V_1_ack_in) | (1'b0 == output_dest_V_1_ack_in)))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == tmp_reg_135)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_tmp_reg_135)))) begin
        output_AX_ALG_TDATA_blk_n = output_data_V_1_state[1'd1];
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == tmp_reg_135) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == tmp_fu_112_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == tmp_fu_112_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_state3_io = ((1'd0 == tmp_reg_135) & (1'b0 == output_data_V_1_ack_in));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((1'd0 == ap_reg_pp0_iter1_tmp_reg_135) & (1'b0 == output_data_V_1_ack_in));
end

assign ap_block_state4_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5 = ((1'b0 == output_data_V_1_ack_in) | (1'b0 == output_keep_V_1_ack_in) | (1'b0 == output_strb_V_1_ack_in) | (1'b0 == output_user_V_1_ack_in) | (1'b0 == output_last_V_1_ack_in) | (1'b0 == output_id_V_1_ack_in) | (1'b0 == output_dest_V_1_ack_in));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign buf_V_address0 = tmp_1_fu_124_p1;

assign i_1_fu_118_p2 = (i_reg_101 + 3'd1);

assign last_assign_fu_129_p2 = ((i_reg_101 == 3'd3) ? 1'b1 : 1'b0);

assign output_AX_ALG_TDATA = output_data_V_1_data_out;

assign output_AX_ALG_TDEST = output_dest_V_1_data_out;

assign output_AX_ALG_TID = output_id_V_1_data_out;

assign output_AX_ALG_TKEEP = output_keep_V_1_data_out;

assign output_AX_ALG_TLAST = output_last_V_1_data_out;

assign output_AX_ALG_TSTRB = output_strb_V_1_data_out;

assign output_AX_ALG_TUSER = output_user_V_1_data_out;

assign output_AX_ALG_TVALID = output_dest_V_1_state[1'd0];

assign output_data_V_1_ack_in = output_data_V_1_state[1'd1];

assign output_data_V_1_ack_out = output_AX_ALG_TREADY;
...
assign output_dest_V_1_ack_out = output_AX_ALG_TREADY;
...
assign output_id_V_1_ack_out = output_AX_ALG_TREADY;
...
assign output_keep_V_1_ack_out = output_AX_ALG_TREADY;
...
assign output_last_V_1_ack_out = output_AX_ALG_TREADY;

assign output_last_V_1_load_A = (output_last_V_1_state_cmp_full & ~output_last_V_1_sel_wr);

assign output_last_V_1_load_B = (output_last_V_1_sel_wr & output_last_V_1_state_cmp_full);
...
assign output_strb_V_1_ack_out = output_AX_ALG_TREADY;
...
assign output_user_V_1_ack_out = output_AX_ALG_TREADY;
...
assign tmp_1_fu_124_p1 = i_reg_101;

assign tmp_fu_112_p2 = ((i_reg_101 == 3'd4) ? 1'b1 : 1'b0);
