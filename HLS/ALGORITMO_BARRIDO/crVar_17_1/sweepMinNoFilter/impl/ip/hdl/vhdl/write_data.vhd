...
begin
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, output_data_V_1_ack_in, output_keep_V_1_ack_in, output_strb_V_1_ack_in, output_user_V_1_ack_in, output_last_V_1_ack_in, output_id_V_1_ack_in, output_dest_V_1_ack_in, ap_CS_fsm_state5)
    begin
        if ((((ap_const_logic_0 = ap_start) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state5) and not(((ap_const_logic_0 = output_data_V_1_ack_in) or (ap_const_logic_0 = output_keep_V_1_ack_in) or (ap_const_logic_0 = output_strb_V_1_ack_in) or (ap_const_logic_0 = output_user_V_1_ack_in) or (ap_const_logic_0 = output_last_V_1_ack_in) or (ap_const_logic_0 = output_id_V_1_ack_in) or (ap_const_logic_0 = output_dest_V_1_ack_in)))))) then 
