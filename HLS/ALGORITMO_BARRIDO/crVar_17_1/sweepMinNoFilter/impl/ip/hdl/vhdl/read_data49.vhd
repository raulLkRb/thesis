...
architecture behav of read_data49 is 
    ...
    signal full_fifo_out_blk_n : STD_LOGIC;
...
begin
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, full_fifo_out_full_n, input_data_V_0_vld_out)
    begin
                ap_block_pp0_stage0_flag00001001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_const_logic_0 = full_fifo_out_full_n) or (ap_done_reg = ap_const_logic_1))) or ((ap_const_logic_0 = input_data_V_0_vld_out) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, full_fifo_out_full_n, input_data_V_0_vld_out)
    begin
                ap_block_pp0_stage0_flag00011001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_const_logic_0 = full_fifo_out_full_n) or (ap_done_reg = ap_const_logic_1))) or ((ap_const_logic_0 = input_data_V_0_vld_out) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, full_fifo_out_full_n, input_data_V_0_vld_out)
    begin
                ap_block_pp0_stage0_flag00011011 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_const_logic_0 = full_fifo_out_full_n) or (ap_done_reg = ap_const_logic_1))) or ((ap_const_logic_0 = input_data_V_0_vld_out) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ap_start, ap_done_reg, full_fifo_out_full_n)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_const_logic_0 = ap_start) or (ap_const_logic_0 = full_fifo_out_full_n) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    full_fifo_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, full_fifo_out_full_n, ap_block_pp0_stage0_flag00000000)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and not(((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))))) then 
            full_fifo_out_blk_n <= full_fifo_out_full_n;
        else 
            full_fifo_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    full_fifo_out_din <= full_fifo;

    full_fifo_out_write_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
            full_fifo_out_write <= ap_const_logic_1;
        else 
            full_fifo_out_write <= ap_const_logic_0;
        end if; 
    end process;
