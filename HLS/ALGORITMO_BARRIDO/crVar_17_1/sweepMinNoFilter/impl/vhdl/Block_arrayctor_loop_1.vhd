...
entity Block_arrayctor_loop_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_arrayctor_loop_1 is 
    ...
    signal p_Val2_s_fu_10_p1 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))))) then 
                    ap_return_preg <= p_Val2_s_fu_10_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_Val2_s_fu_10_p1, ap_return_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))))) then 
            ap_return <= p_Val2_s_fu_10_p1;
        else 
            ap_return <= ap_return_preg;
        end if; 
    end process;

    p_Val2_s_fu_10_p1 <= p_read(24 - 1 downto 0);
end behav;
