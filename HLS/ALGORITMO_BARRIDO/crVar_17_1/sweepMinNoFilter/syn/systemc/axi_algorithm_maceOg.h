...
#ifndef __axi_algorithm_maceOg__HH__
#define __axi_algorithm_maceOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(axi_algorithm_maceOg) {
    ...
    SC_CTOR(axi_algorithm_maceOg):  simcore_mac_0_U ("simcore_mac_0_U") {
