...
set portList { 
	...
	{ input_AX_ALG_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ input_AX_ALG_TDATA_blk_n sc_out sc_logic 1 signal -1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_AX_ALG_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "input_data_V", "role": "TVALID" }} , 
 	...
 	{ "name": "input_AX_ALG_TDATA_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_AX_ALG_TDATA_blk_n", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	input_data_V { axis {  { input_AX_ALG_TDATA in_data 0 32 }  { input_AX_ALG_TVALID in_vld 0 1 } } }
	...
	input_dest_V { axis {  { input_AX_ALG_TREADY in_acc 1 1 }  { input_AX_ALG_TDEST in_data 0 5 } } }
}
