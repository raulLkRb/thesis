...
set C_modelArgMapList {[ 
	{ "Name" : "buf_0_V_read", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buf_0_V_read sc_in sc_lv 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_0_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_0_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.axi_algorithm_muxg8j_U2061", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	buf_0_V_read { ap_none {  { buf_0_V_read in_data 0 1 } } }
