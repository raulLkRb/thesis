...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_stream_TUSER", 4, hls_out, 10, "axis", "out_data", 1),
	Port_Property("out_stream_TLAST", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("out_stream_TID", 5, hls_out, 12, "axis", "out_data", 1),
	Port_Property("out_stream_TDEST", 5, hls_out, 13, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "wrapped_mmult_hw";
