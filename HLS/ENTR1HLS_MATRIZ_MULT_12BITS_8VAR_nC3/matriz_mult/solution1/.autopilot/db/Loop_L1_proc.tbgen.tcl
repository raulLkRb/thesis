...
set C_modelArgList {
	{ X_OUT_0 float 32 regular {array 3 { 0 3 } 0 1 }  }
	{ X_MAT_0 float 32 regular {array 8 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "X_OUT_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "X_MAT_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ X_OUT_0_we0 sc_out sc_logic 1 signal 0 } 
	{ X_OUT_0_d0 sc_out sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "X_OUT_0_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "X_OUT_0", "role": "we0" }} , 
 	{ "name": "X_OUT_0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "X_OUT_0", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "X_OUT_0", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "X_MAT_0", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "coeff", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.coeff_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.wrapped_mmult_hw_eOg_U14", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.wrapped_mmult_hw_fYi_U15", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	X_OUT_0 { ap_memory {  { X_OUT_0_address0 mem_address 1 2 }  { X_OUT_0_ce0 mem_ce 1 1 }  { X_OUT_0_we0 mem_we 1 1 }  { X_OUT_0_d0 mem_din 1 32 } } }
	X_MAT_0 { ap_memory {  { X_MAT_0_address0 mem_address 1 3 }  { X_MAT_0_ce0 mem_ce 1 1 }  { X_MAT_0_q0 mem_dout 0 32 } } }
}
