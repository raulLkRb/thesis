...
set ID 27
set MemName wrapped_mmult_hw_g8j_memcore
...
set MemName wrapped_mmult_hw_g8j
...
# Memory (RAM/ROM)  definition:
set ID 28
set MemName wrapped_mmult_hw_hbi_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 8
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName wrapped_mmult_hw_hbi
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# Memory (RAM/ROM)  definition:
set ID 29
set MemName wrapped_mmult_hw_ibs_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 3
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName wrapped_mmult_hw_ibs
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TDEST { I 5 vector } in_stream_TVALID { I 1 bit } in_stream_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TDEST { O 5 vector } out_stream_TVALID { O 1 bit } out_stream_TREADY { I 1 bit } } \
} "
} else {
