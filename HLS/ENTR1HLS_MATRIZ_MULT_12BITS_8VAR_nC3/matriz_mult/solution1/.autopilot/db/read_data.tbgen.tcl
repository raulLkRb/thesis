...
set C_modelArgList {
	...
	{ input_keep_V int 4 regular {axi_s 0 volatile  { in_stream Keep } }  }
	{ input_strb_V int 4 regular {axi_s 0 volatile  { in_stream Strb } }  }
	{ input_user_V int 4 regular {axi_s 0 volatile  { in_stream User } }  }
	{ input_last_V int 1 regular {axi_s 0 volatile  { in_stream Last } }  }
	{ input_id_V int 5 regular {axi_s 0 volatile  { in_stream ID } }  }
	{ input_dest_V int 5 regular {axi_s 0 volatile  { in_stream Dest } }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_stream_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "input_dest_V", "role": "LID" }} , 
 	{ "name": "in_stream_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "input_dest_V", "role": "ADY" }} , 
 	{ "name": "in_stream_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "input_keep_V", "role": "EP" }} , 
 	{ "name": "in_stream_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "input_strb_V", "role": "RB" }} , 
 	{ "name": "in_stream_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "input_user_V", "role": "ER" }} , 
 	{ "name": "in_stream_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "input_last_V", "role": "ST" }} , 
 	{ "name": "in_stream_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "input_id_V", "role": "ID" }} , 
 	{ "name": "in_stream_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "input_dest_V", "role": "ST" }} , 
...
set Spec2ImplPortList { 
	...
	input_keep_V { axis {  { in_stream_TKEEP in_data 0 4 } } }
	input_strb_V { axis {  { in_stream_TSTRB in_data 0 4 } } }
	input_user_V { axis {  { in_stream_TUSER in_data 0 4 } } }
	input_last_V { axis {  { in_stream_TLAST in_data 0 1 } } }
	input_id_V { axis {  { in_stream_TID in_data 0 5 } } }
	input_dest_V { axis {  { in_stream_TVALID in_vld 0 1 }  { in_stream_TREADY in_acc 1 1 }  { in_stream_TDEST in_data 0 5 } } }
