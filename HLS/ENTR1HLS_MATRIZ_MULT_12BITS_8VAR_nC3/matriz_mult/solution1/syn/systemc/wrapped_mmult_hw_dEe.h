...
#ifndef __wrapped_mmult_hw_dEe__HH__
#define __wrapped_mmult_hw_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(wrapped_mmult_hw_dEe) {
    ...
    SC_CTOR(wrapped_mmult_hw_dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
