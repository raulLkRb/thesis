...
void wrapped_mmult_hw_ibs::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void wrapped_mmult_hw_ibs::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void wrapped_mmult_hw_ibs::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void wrapped_mmult_hw_ibs::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
