...
assign buf_V_address0 = tmp_s_fu_104_p1;

assign buf_V_d0 = input_data_V_0_data_out;

assign i_1_fu_98_p2 = (i_phi_fu_84_p4 + 3'd1);

assign in_stream_TREADY = input_dest_V_0_state[1'd1];
...
assign input_dest_V_0_vld_in = in_stream_TVALID;

assign tmp_fu_92_p2 = ((i_phi_fu_84_p4 == 3'd4) ? 1'b1 : 1'b0);

assign tmp_s_fu_104_p1 = i_reg_80;
