...
architecture behav of read_data is 
    ...
    signal i_1_fu_98_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_1_reg_118 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal ap_block_state1 : BOOLEAN;
    signal ap_block_pp0_stage0_flag00011011 : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state2 : STD_LOGIC;
    signal i_phi_fu_84_p4 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, tmp_fu_92_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_flag00011011)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_fu_92_p2)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_fu_92_p2))) then
    ...
    ap_block_pp0_stage0_flag00011001_assign_proc : process(input_data_V_0_vld_out, ap_enable_reg_pp0_iter1, tmp_reg_114)
    begin
                ap_block_pp0_stage0_flag00011001 <= ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_const_logic_0 = input_data_V_0_vld_out));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(input_data_V_0_vld_out, ap_enable_reg_pp0_iter1, tmp_reg_114)
    begin
                ap_block_pp0_stage0_flag00011011 <= ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_const_logic_0 = input_data_V_0_vld_out));
    end process;
    ...
    ap_block_state3_pp0_stage0_iter1_assign_proc : process(input_data_V_0_vld_out, tmp_reg_114)
    begin
                ap_block_state3_pp0_stage0_iter1 <= ((ap_const_lv1_0 = tmp_reg_114) and (ap_const_logic_0 = input_data_V_0_vld_out));
    end process;


    ap_condition_pp0_exit_iter0_state2_assign_proc : process(tmp_fu_92_p2)
    begin
        if ((ap_const_lv1_1 = tmp_fu_92_p2)) then 
    ...
    buf_V_address0 <= tmp_s_fu_104_p1(2 - 1 downto 0);

    buf_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00011001)
    begin
    ...
    buf_V_d0 <= input_data_V_0_data_out;

    buf_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_114, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    i_1_fu_98_p2 <= std_logic_vector(unsigned(i_phi_fu_84_p4) + unsigned(ap_const_lv3_1));

    i_phi_fu_84_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, tmp_reg_114, i_reg_80, i_1_reg_118)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = tmp_reg_114))) then 
    ...
    in_stream_TDATA_blk_n_assign_proc : process(input_data_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, tmp_reg_114)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = tmp_reg_114))) then 
    ...
    in_stream_TREADY <= input_dest_V_0_state(1);
    input_data_V_0_ack_in <= input_data_V_0_state(1);

    input_data_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_114, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    input_dest_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_114, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = tmp_reg_114) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    input_dest_V_0_vld_in <= in_stream_TVALID;
    tmp_fu_92_p2 <= "1" when (i_phi_fu_84_p4 = ap_const_lv3_4) else "0";
    tmp_s_fu_104_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_80),32));
end behav;
