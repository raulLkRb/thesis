...
HD_PWD='C:/Users/Raul/Documents/RIGIDEZ_VIVADO/PCA_IMPL/ENTR1HLS_MATRIZ_MULT_12BITS_8VAR_nC3/matriz_mult/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapped_mmult_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapped_mmult_hw.tcl
