...
#ifndef _write_data21_HH_
#define _write_data21_HH_
...
struct write_data21 : public sc_module {
    ...
    // Module declarations
    write_data21(sc_module_name name);
    SC_HAS_PROCESS(write_data21);
    ...
    sc_signal< sc_logic > output_AX_ALGdedo0_TDATA_blk_n;
    ...
    void thread_output_AX_ALGdedo0_TDATA_blk_n();
