...
#ifndef _write_data22_HH_
#define _write_data22_HH_
...
struct write_data22 : public sc_module {
    ...
    // Module declarations
    write_data22(sc_module_name name);
    SC_HAS_PROCESS(write_data22);
    ...
    sc_signal< sc_logic > output_AX_ALGpalma0_TDATA_blk_n;
    ...
    void thread_output_AX_ALGpalma0_TDATA_blk_n();
