...
#ifndef _write_data23_HH_
#define _write_data23_HH_
...
struct write_data23 : public sc_module {
    ...
    // Module declarations
    write_data23(sc_module_name name);
    SC_HAS_PROCESS(write_data23);
    ...
    sc_signal< sc_logic > output_AX_ALGdedo1_TDATA_blk_n;
    ...
    void thread_output_AX_ALGdedo1_TDATA_blk_n();
