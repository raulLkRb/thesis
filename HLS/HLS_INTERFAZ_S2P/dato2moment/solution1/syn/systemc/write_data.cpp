...
const sc_lv<1> write_data::ap_ST_fsm_pp0_stage0 = "1";
...
write_data::write_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_output_AX_ALGpalma1_TDATA_blk_n);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    ...
    sensitive << ( output_AX_ALGpalma1_TREADY );
    ...
    sc_trace(mVcdFile, output_AX_ALGpalma1_TDATA_blk_n, "output_AX_ALGpalma1_TDATA_blk_n");
...
void write_data::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, output_data_V_1_load_A.read())) {
        output_data_V_1_payload_A = buf_0_V_read.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, output_data_V_1_load_B.read())) {
        output_data_V_1_payload_B = buf_0_V_read.read();
    }
}
...
void write_data::thread_ap_block_state1_pp0_stage0_iter0() {
...
void write_data::thread_ap_block_state2_pp0_stage0_iter1() {
...
void write_data::thread_ap_enable_reg_pp0_iter0() {
...
void write_data::thread_ap_idle_pp0_0to0() {
    if (esl_seteq<1,1,1>(ap_const_logic_0, ap_enable_reg_pp0_iter0.read())) {
...
void write_data::thread_ap_reset_idle_pp0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) && 
...
void write_data::thread_output_AX_ALGpalma1_TDATA() {
    output_AX_ALGpalma1_TDATA = output_data_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_start.read()) && 
         ...
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
          esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00000000.read(), ap_const_boolean_0)))) {
        output_AX_ALGpalma1_TDATA_blk_n = output_data_V_1_state.read()[1];
    } else {
        output_AX_ALGpalma1_TDATA_blk_n = ap_const_logic_1;
    }
}

void write_data::thread_output_AX_ALGpalma1_TDEST() {
    output_AX_ALGpalma1_TDEST = output_dest_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TID() {
    output_AX_ALGpalma1_TID = output_id_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TKEEP() {
    output_AX_ALGpalma1_TKEEP = output_keep_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TLAST() {
    output_AX_ALGpalma1_TLAST = output_last_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TSTRB() {
    output_AX_ALGpalma1_TSTRB = output_strb_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TUSER() {
    output_AX_ALGpalma1_TUSER = output_user_V_1_data_out.read();
}

void write_data::thread_output_AX_ALGpalma1_TVALID() {
    output_AX_ALGpalma1_TVALID = output_dest_V_1_state.read()[0];
}
...
void write_data::thread_output_data_V_1_ack_out() {
    output_data_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_dest_V_1_ack_out() {
    output_dest_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_id_V_1_ack_out() {
    output_id_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_keep_V_1_ack_out() {
    output_keep_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_last_V_1_ack_out() {
    output_last_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_strb_V_1_ack_out() {
    output_strb_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
...
void write_data::thread_output_user_V_1_ack_out() {
    output_user_V_1_ack_out = output_AX_ALGpalma1_TREADY.read();
}
