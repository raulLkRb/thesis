...
architecture behav of read_data is 
    ...
    signal tmp_1_fu_104_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    buf_V_address0 <= tmp_1_fu_104_p1(2 - 1 downto 0);
    ...
    input_AX_ALG_TDATA_blk_n_assign_proc : process(input_data_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, tmp_reg_114)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = tmp_reg_114))) then 
    ...
    tmp_1_fu_104_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_80),32));
