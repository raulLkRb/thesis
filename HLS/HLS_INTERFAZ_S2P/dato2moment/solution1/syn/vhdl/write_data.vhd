...
architecture behav of write_data is 
    ...
    signal output_AX_ALGpalma1_TDATA_blk_n : STD_LOGIC;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = output_data_V_1_load_A)) then
                output_data_V_1_payload_A <= buf_0_V_read;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = output_data_V_1_load_B)) then
                output_data_V_1_payload_B <= buf_0_V_read;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, output_data_V_1_ack_in, output_keep_V_1_ack_in, output_strb_V_1_ack_in, output_user_V_1_ack_in, output_last_V_1_ack_in, output_id_V_1_ack_in, output_dest_V_1_ack_in)
    begin
                ap_block_pp0_stage0_flag00001001 <= ((ap_done_reg = ap_const_logic_1) or (((ap_const_logic_0 = output_data_V_1_ack_in) or (ap_const_logic_0 = output_keep_V_1_ack_in) or (ap_const_logic_0 = output_strb_V_1_ack_in) or (ap_const_logic_0 = output_user_V_1_ack_in) or (ap_const_logic_0 = output_last_V_1_ack_in) or (ap_const_logic_0 = output_id_V_1_ack_in) or (ap_const_logic_0 = output_dest_V_1_ack_in)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, output_data_V_1_ack_in, output_keep_V_1_ack_in, output_strb_V_1_ack_in, output_user_V_1_ack_in, output_last_V_1_ack_in, output_id_V_1_ack_in, output_dest_V_1_ack_in)
    begin
                ap_block_pp0_stage0_flag00011001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1) or (ap_const_logic_0 = output_data_V_1_ack_in))) or (((ap_const_logic_0 = output_data_V_1_ack_in) or (ap_const_logic_0 = output_keep_V_1_ack_in) or (ap_const_logic_0 = output_strb_V_1_ack_in) or (ap_const_logic_0 = output_user_V_1_ack_in) or (ap_const_logic_0 = output_last_V_1_ack_in) or (ap_const_logic_0 = output_id_V_1_ack_in) or (ap_const_logic_0 = output_dest_V_1_ack_in)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, output_data_V_1_ack_in, output_keep_V_1_ack_in, output_strb_V_1_ack_in, output_user_V_1_ack_in, output_last_V_1_ack_in, output_id_V_1_ack_in, output_dest_V_1_ack_in)
    begin
                ap_block_pp0_stage0_flag00011011 <= ((ap_done_reg = ap_const_logic_1) or ((ap_const_logic_1 = ap_start) and ((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1) or (ap_const_logic_0 = output_data_V_1_ack_in))) or (((ap_const_logic_0 = output_data_V_1_ack_in) or (ap_const_logic_0 = output_keep_V_1_ack_in) or (ap_const_logic_0 = output_strb_V_1_ack_in) or (ap_const_logic_0 = output_user_V_1_ack_in) or (ap_const_logic_0 = output_last_V_1_ack_in) or (ap_const_logic_0 = output_id_V_1_ack_in) or (ap_const_logic_0 = output_dest_V_1_ack_in)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(output_data_V_1_ack_in, output_keep_V_1_ack_in, output_strb_V_1_ack_in, output_user_V_1_ack_in, output_last_V_1_ack_in, output_id_V_1_ack_in, output_dest_V_1_ack_in)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_const_logic_0 = output_data_V_1_ack_in) or (ap_const_logic_0 = output_keep_V_1_ack_in) or (ap_const_logic_0 = output_strb_V_1_ack_in) or (ap_const_logic_0 = output_user_V_1_ack_in) or (ap_const_logic_0 = output_last_V_1_ack_in) or (ap_const_logic_0 = output_id_V_1_ack_in) or (ap_const_logic_0 = output_dest_V_1_ack_in));
    end process;
    ...
    output_AX_ALGpalma1_TDATA <= output_data_V_1_data_out;

    output_AX_ALGpalma1_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, output_data_V_1_state, ap_block_pp0_stage0_flag00000000)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and not(((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0)))) then 
            output_AX_ALGpalma1_TDATA_blk_n <= output_data_V_1_state(1);
        else 
            output_AX_ALGpalma1_TDATA_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    output_AX_ALGpalma1_TDEST <= output_dest_V_1_data_out;
    output_AX_ALGpalma1_TID <= output_id_V_1_data_out;
    output_AX_ALGpalma1_TKEEP <= output_keep_V_1_data_out;
    output_AX_ALGpalma1_TLAST <= output_last_V_1_data_out;
    output_AX_ALGpalma1_TSTRB <= output_strb_V_1_data_out;
    output_AX_ALGpalma1_TUSER <= output_user_V_1_data_out;
    output_AX_ALGpalma1_TVALID <= output_dest_V_1_state(0);
    output_data_V_1_ack_in <= output_data_V_1_state(1);
    output_data_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    ...
    output_data_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_dest_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_dest_V_1_data_out <= ap_const_lv5_0;
    output_dest_V_1_sel <= output_dest_V_1_sel_rd;

    output_dest_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_id_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_id_V_1_data_out <= ap_const_lv5_0;
    output_id_V_1_sel <= output_id_V_1_sel_rd;

    output_id_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_keep_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_keep_V_1_data_out <= ap_const_lv4_F;
    output_keep_V_1_sel <= output_keep_V_1_sel_rd;

    output_keep_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_last_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_last_V_1_data_out <= ap_const_lv1_1;
    output_last_V_1_sel <= output_last_V_1_sel_rd;

    output_last_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_strb_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_strb_V_1_data_out <= ap_const_lv4_F;
    output_strb_V_1_sel <= output_strb_V_1_sel_rd;

    output_strb_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    output_user_V_1_ack_out <= output_AX_ALGpalma1_TREADY;
    output_user_V_1_data_out <= ap_const_lv4_0;
    output_user_V_1_sel <= output_user_V_1_sel_rd;

    output_user_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
