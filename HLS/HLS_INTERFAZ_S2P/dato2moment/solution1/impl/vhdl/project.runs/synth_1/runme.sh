...
HD_PWD='C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_INTERFAZ_INIT_SIMPLE_MAXMOM/dato2moment/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_algorithm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_algorithm.tcl
