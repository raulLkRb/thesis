...
HD_PWD='C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_INTERFAZ_INIT_SIMPLE_MAXMOM/dato2moment/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_algorithm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_algorithm.tcl -notrace
