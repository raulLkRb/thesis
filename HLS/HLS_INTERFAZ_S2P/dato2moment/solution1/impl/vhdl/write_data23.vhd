...
architecture behav of write_data23 is 
    ...
    signal output_AX_ALGdedo1_TDATA_blk_n : STD_LOGIC;
...
begin
    ...
    output_AX_ALGdedo1_TDATA <= output_data_V_1_data_out;

    output_AX_ALGdedo1_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, output_data_V_1_state, ap_block_pp0_stage0_flag00000000)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_start) and not(((ap_const_logic_0 = ap_start) or (ap_done_reg = ap_const_logic_1))) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0)))) then 
            output_AX_ALGdedo1_TDATA_blk_n <= output_data_V_1_state(1);
        else 
            output_AX_ALGdedo1_TDATA_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    output_AX_ALGdedo1_TDEST <= output_dest_V_1_data_out;
    output_AX_ALGdedo1_TID <= output_id_V_1_data_out;
    output_AX_ALGdedo1_TKEEP <= output_keep_V_1_data_out;
    output_AX_ALGdedo1_TLAST <= output_last_V_1_data_out;
    output_AX_ALGdedo1_TSTRB <= output_strb_V_1_data_out;
    output_AX_ALGdedo1_TUSER <= output_user_V_1_data_out;
    output_AX_ALGdedo1_TVALID <= output_dest_V_1_state(0);
    output_data_V_1_ack_in <= output_data_V_1_state(1);
    output_data_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_dest_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_id_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_keep_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_last_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_strb_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
    ...
    output_user_V_1_ack_out <= output_AX_ALGdedo1_TREADY;
