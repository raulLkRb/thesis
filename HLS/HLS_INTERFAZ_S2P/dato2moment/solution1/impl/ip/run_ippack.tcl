...
set Library     "hls"
set IPName      "axi_algorithm"
set Version     "1.0"
set DisplayName "Axi_algorithm"
set Revision    "2102011351"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "axi_algorithm"
...
set Interfaces {
    ap_clk {
        ...
        buses "input_AX_ALG output_AX_ALGdedo0 output_AX_ALGpalma0 output_AX_ALGdedo1 output_AX_ALGpalma1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    output_AX_ALGdedo0 {
        type "axi4stream"
        mode "master"
        port_prefix "output_AX_ALGdedo0"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    output_AX_ALGpalma0 {
        type "axi4stream"
        mode "master"
        port_prefix "output_AX_ALGpalma0"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    output_AX_ALGdedo1 {
        type "axi4stream"
        mode "master"
        port_prefix "output_AX_ALGdedo1"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    output_AX_ALGpalma1 {
        type "axi4stream"
        mode "master"
        port_prefix "output_AX_ALGpalma1"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 11 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_INTERFAZ_INIT_SIMPLE_MAXMOM/axi_algorithm.cpp}
if {$enable_xo_gen} {
