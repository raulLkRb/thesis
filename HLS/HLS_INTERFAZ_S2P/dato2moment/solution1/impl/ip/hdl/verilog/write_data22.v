...
reg    output_AX_ALGpalma0_TDATA_blk_n;
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_start) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1)) & (ap_block_pp0_stage0_flag00000000 == 1'b0)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0)))) begin
        output_AX_ALGpalma0_TDATA_blk_n = output_data_V_1_state[1'd1];
    end else begin
        output_AX_ALGpalma0_TDATA_blk_n = 1'b1;
    end
end
...
assign output_AX_ALGpalma0_TDATA = output_data_V_1_data_out;

assign output_AX_ALGpalma0_TDEST = output_dest_V_1_data_out;

assign output_AX_ALGpalma0_TID = output_id_V_1_data_out;

assign output_AX_ALGpalma0_TKEEP = output_keep_V_1_data_out;

assign output_AX_ALGpalma0_TLAST = output_last_V_1_data_out;

assign output_AX_ALGpalma0_TSTRB = output_strb_V_1_data_out;

assign output_AX_ALGpalma0_TUSER = output_user_V_1_data_out;

assign output_AX_ALGpalma0_TVALID = output_dest_V_1_state[1'd0];

assign output_data_V_1_ack_in = output_data_V_1_state[1'd1];

assign output_data_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_dest_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_id_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_keep_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_last_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_strb_V_1_ack_out = output_AX_ALGpalma0_TREADY;
...
assign output_user_V_1_ack_out = output_AX_ALGpalma0_TREADY;
