...
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int M00_dedo[1], int M01_dedo[1], int M10_dedo[1], int M02_dedo[1], int M20_dedo[1], int M11_dedo[1], int M00_palma[1], int M01_palma[1], int M10_palma[1], int M02_palma[1], int M20_palma[1], int M11_palma[1], bool full_fifo);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, int& M10_dedo, int& M10_palma, int& M02_dedo, int& M02_palma, int& M20_dedo, int& M20_palma, int& M11_dedo, int& M11_palma, bool t_ready_in);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, int& M10_dedo, int& M10_palma, int& M02_dedo, int& M02_palma, int& M20_dedo, int& M20_palma, int& M11_dedo, int& M11_palma);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, int& M10_dedo, int& M10_palma, int& M02_dedo, int& M02_palma);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, bool t_ready_in);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, bool t_ready_in0, bool t_ready_in1, bool t_ready_in2, bool t_ready_in3);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, bool t_ready_in);
//void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], int& M00_dedo, int& M00_palma, int& M01_dedo, int& M01_palma, bool t_ready_in);
void axi_algorithm(AXI_VAL input_AX_ALG[N_MOMENT], AXI_VAL output_AX_ALGdedo0[N_MOMENT],AXI_VAL output_AX_ALGpalma0[N_MOMENT],AXI_VAL output_AX_ALGdedo1[N_MOMENT],AXI_VAL output_AX_ALGpalma1[N_MOMENT]);
