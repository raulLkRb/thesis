...
/* VELOCIDAD 10 , M-256*/
	...
	// Definimos num_rows y num_cols
	num_rows = sizeof(data_in_extern_V10) / sizeof(data_in_extern_V10[0]);
	num_cols = sizeof(data_in_extern_V10[0]) / sizeof(data_in_extern_V10[0][0]);

	contador = 0;


	// Abrimos fichero de escritura
	fp = fopen("descriptors_V10_1024.dat","w");
	...
	for(ii=0; ii<num_rows; ii++)
	{
		...
		{
			buf_in[0] = data_in_extern_V10[ii][i];// & 0x0000FFFF;
