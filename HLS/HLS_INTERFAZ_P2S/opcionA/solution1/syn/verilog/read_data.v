...
module read_data (
        ...
        ap_return,
        input_AX_ALGpalma1_TDATA_blk_n
);
...
output   input_AX_ALGpalma1_TDATA_blk_n;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg input_AX_ALGpalma1_TREADY;
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (1'b0 == input_AX_ALGpalma1_TVALID))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (1'b0 == input_AX_ALGpalma1_TVALID)))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (1'b0 == input_AX_ALGpalma1_TVALID)))) begin
        input_AX_ALGpalma1_TREADY = 1'b1;
    end else begin
        input_AX_ALGpalma1_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == ap_start) | (1'b0 == input_AX_ALGpalma1_TVALID));
end

assign ap_return = input_AX_ALGpalma1_TDATA;
