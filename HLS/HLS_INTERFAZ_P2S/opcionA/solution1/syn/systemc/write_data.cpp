...
write_data::write_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    opcionA_mux_42_32_1_U7 = new opcionA_mux_42_32_1<1,1,32,32,32,32,2,32>("opcionA_mux_42_32_1_U7");
    opcionA_mux_42_32_1_U7->din1(buf_0_V_read);
    opcionA_mux_42_32_1_U7->din2(buf_1_V_read);
    opcionA_mux_42_32_1_U7->din3(buf_2_V_read);
    opcionA_mux_42_32_1_U7->din4(buf_3_V_read);
    opcionA_mux_42_32_1_U7->din5(p_Val2_s_fu_155_p5);
    opcionA_mux_42_32_1_U7->dout(p_Val2_s_fu_155_p6);
    ...
    SC_METHOD(thread_last_assign_fu_145_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( i_reg_122 );
    sensitive << ( tmp_fu_133_p2 );
    ...
    SC_METHOD(thread_p_Val2_s_fu_155_p5);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( i_reg_122 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    sc_trace(mVcdFile, buf_1_V_read, "(port)buf_1_V_read");
    sc_trace(mVcdFile, buf_2_V_read, "(port)buf_2_V_read");
    sc_trace(mVcdFile, buf_3_V_read, "(port)buf_3_V_read");
    ...
    sc_trace(mVcdFile, last_assign_fu_145_p2, "last_assign_fu_145_p2");
    sc_trace(mVcdFile, last_assign_reg_194, "last_assign_reg_194");
    sc_trace(mVcdFile, p_Val2_s_fu_155_p6, "p_Val2_s_fu_155_p6");
    sc_trace(mVcdFile, p_Val2_s_reg_199, "p_Val2_s_reg_199");
    ...
    sc_trace(mVcdFile, p_Val2_s_fu_155_p5, "p_Val2_s_fu_155_p5");
...
void write_data::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        i_reg_122 = i_1_fu_139_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_122 = ap_const_lv3_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_133_p2.read()))) {
        last_assign_reg_194 = last_assign_fu_145_p2.read();
        p_Val2_s_reg_199 = p_Val2_s_fu_155_p6.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        tmp_reg_185 = tmp_fu_133_p2.read();
    }
}
...
void write_data::thread_ap_block_state3_io() {
    ap_block_state3_io = (esl_seteq<1,1,1>(tmp_reg_185.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_0, ap_sig_ioackin_output_AX_ALG_TREADY.read()));
}
...
void write_data::thread_ap_condition_169() {
    ap_condition_169 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(tmp_reg_185.read(), ap_const_lv1_0));
}
...
void write_data::thread_i_1_fu_139_p2() {
    i_1_fu_139_p2 = (!i_reg_122.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_reg_122.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void write_data::thread_last_assign_fu_145_p2() {
    last_assign_fu_145_p2 = (!i_reg_122.read().is_01() || !ap_const_lv3_3.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_122.read() == ap_const_lv3_3);
}

void write_data::thread_output_AX_ALG_TDATA() {
    output_AX_ALG_TDATA = p_Val2_s_reg_199.read();
}
...
void write_data::thread_output_AX_ALG_TDATA_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(tmp_reg_185.read(), ap_const_lv1_0))) {
...
void write_data::thread_output_AX_ALG_TLAST() {
    output_AX_ALG_TLAST = last_assign_reg_194.read();
}
...
void write_data::thread_p_Val2_s_fu_155_p5() {
    p_Val2_s_fu_155_p5 = i_reg_122.read().range(2-1, 0);
}

void write_data::thread_tmp_fu_133_p2() {
    tmp_fu_133_p2 = (!i_reg_122.read().is_01() || !ap_const_lv3_4.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_122.read() == ap_const_lv3_4);
}
...
void write_data::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_fu_133_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011011.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_fu_133_p2.read(), ap_const_lv1_1))) {
