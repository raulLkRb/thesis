...
HD_PWD='C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_ARRAY_OUT_SIMPLE/opcionA/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opcionA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opcionA.tcl -notrace
