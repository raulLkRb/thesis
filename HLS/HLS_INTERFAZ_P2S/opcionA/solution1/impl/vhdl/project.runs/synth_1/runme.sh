...
HD_PWD='C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_ARRAY_OUT_SIMPLE/opcionA/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log opcionA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source opcionA.tcl
