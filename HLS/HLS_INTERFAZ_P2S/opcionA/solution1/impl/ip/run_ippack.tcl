...
set IPName      "opcionA"
set Version     "1.0"
set DisplayName "Opciona"
set Revision    "2102011643"
...
set Interfaces {
    ap_clk {
        ...
        buses "input_AX_ALGdedo0 input_AX_ALGpalma0 input_AX_ALGdedo1 input_AX_ALGpalma1 output_AX_ALG"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    input_AX_ALGpalma0 {
        type "axi4stream"
        mode "slave"
        port_prefix "input_AX_ALGpalma0"
        has_tready "1"
        ports {
            TDATA 32
            TDEST 5
    ...
    input_AX_ALGpalma1 {
        type "axi4stream"
        mode "slave"
        port_prefix "input_AX_ALGpalma1"
        has_tready "1"
        ports {
            TDATA 32
            TDEST 5
...
set enable_xo_gen 0
set kernel_files {C:/Users/Raul/Documents/RIGIDEZ_VIVADO/HLS_ARRAY_OUT_SIMPLE/axi_algorithm.cpp}
if {$enable_xo_gen} {
