...
set C_modelArgList {
	...
	{ buf_1_V_read int 32 regular  }
	{ buf_2_V_read int 32 regular  }
	{ buf_3_V_read int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buf_0_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buf_1_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buf_2_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buf_3_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buf_1_V_read sc_in sc_lv 32 signal 1 } 
	{ buf_2_V_read sc_in sc_lv 32 signal 2 } 
	{ buf_3_V_read sc_in sc_lv 32 signal 3 } 
	{ output_AX_ALG_TDATA sc_out sc_lv 32 signal 4 } 
	{ output_AX_ALG_TVALID sc_out sc_logic 1 outvld 10 } 
	{ output_AX_ALG_TREADY sc_in sc_logic 1 outacc 10 } 
	{ output_AX_ALG_TKEEP sc_out sc_lv 4 signal 5 } 
	{ output_AX_ALG_TSTRB sc_out sc_lv 4 signal 6 } 
	{ output_AX_ALG_TUSER sc_out sc_lv 4 signal 7 } 
	{ output_AX_ALG_TLAST sc_out sc_lv 1 signal 8 } 
	{ output_AX_ALG_TID sc_out sc_lv 5 signal 9 } 
	{ output_AX_ALG_TDEST sc_out sc_lv 5 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_1_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf_1_V_read", "role": "default" }} , 
 	{ "name": "buf_2_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf_2_V_read", "role": "default" }} , 
 	{ "name": "buf_3_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf_3_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.opcionA_mux_42_32_1_U7", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	buf_1_V_read { ap_none {  { buf_1_V_read in_data 0 32 } } }
	buf_2_V_read { ap_none {  { buf_2_V_read in_data 0 32 } } }
	buf_3_V_read { ap_none {  { buf_3_V_read in_data 0 32 } } }
