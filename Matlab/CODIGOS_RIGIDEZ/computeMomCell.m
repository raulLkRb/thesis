...
function [momentumCell,indicesMomentum,indicesMaximo] = computeMomCell(M00,M10,M01,M20,M11,M02,prominencia)
...
%         if(length(vAux)>1000)
    ...
    %% Calculamos los indices de los maximos
    vv = M00;
    maxvv = islocalmax(vv,'MinSeparation',1200,'MinProminence',prominencia);
    indmaxvv = find(maxvv == 1);
    indicesMaximo = indmaxvv;
